...
int main(){
    std::string img_path="/home/qiu/Projects/Self-Correction-Human-Parsing/deploy/schp_libtorch/15948686054672.png";
    int nums=100;
    ...
    std::cout<<t/cv::getTickFrequency()/nums<<"s/per_img"<<std::endl;
